...
kerasAC_predict_tdb \
    ...
    --predictions_and_labels_hdf5 s3://encode-models/predictions.ENCODE.dnase.regression.$2 \
    --load_model_hdf5 s3://encode-dnase-models/ENCODE.dnase.regression.$2.hdf5
